...
internal sealed class EnumMemberJsonConverterFactory : JsonConverterFactory
{
    ...
    private sealed class EnumMemberJsonConverter<TEnum> : JsonConverter<TEnum> where TEnum : struct, Enum
    {
        ...
        {
            if (reader.TokenType == JsonTokenType.String && TryParseWireValue(reader.GetString()!, out TEnum value))
                return value;
        ...
        {
            if (!TryGetWireValue(value, out string? wireValue))
        ...
        {
            if (TryParseWireValue(reader.GetString()!, out TEnum value))
                return value;
        ...
        private static bool TryGetWireValue(TEnum value, out string? wireValue)
        {
        ...
        private static bool TryParseWireValue(string wireValue, out TEnum value)
        {
