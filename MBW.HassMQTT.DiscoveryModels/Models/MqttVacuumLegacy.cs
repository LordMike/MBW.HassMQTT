...
namespace MBW.HassMQTT.DiscoveryModels.Models
{
    ...
    [PublicAPI]
    public class MqttVacuumLegacy : MqttSensorDiscoveryBase<MqttVacuumLegacy, MqttVacuumLegacy.MqttVacuumLegacyValidator>, IHasUniqueId, IHasAvailability, IHasQos, IHasJsonAttributes, IHasIcon, IHasEnabledByDefault, IHasRetain, IHasEntityCategory
    {
